              ...
              {mode === "login" ? (
                ...
                >
                  <h2 className="text-3xl font-bold leading-tight">
                    Chào mừng trở lại trung tâm điều hành.
                  </h2>
                  <p className="text-teal-100/60 text-sm">
                    Quản lý nhà hàng của bạn với dữ liệu thời gian thực và độ
                    chính xác tuyệt đối.
                  </p>
                </motion.div>
              ) : (
                ...
                >
                  <h2 className="text-3xl font-bold leading-tight">
                    Bắt đầu quản lý thông minh ngay hôm nay.
                  </h2>
                  <p className="text-teal-100/60 text-sm">
                    Gia nhập cộng đồng 1000+ nhà hàng đang tối ưu vận hành cùng
                    IRMS Pro.
                  </p>
                </motion.div>
              )}
          ...
          <div className="flex mb-10 border-b border-slate-100 sticky top-0 bg-white z-10 pt-2">
            <button
              ...
              className={`flex-1 pb-4 text-center text-sm transition-all ${
                mode === "login"
                  ? "font-bold border-b-2 border-[#0F4C5C] text-[#0F4C5C]"
            ...
            <button
              ...
              className={`flex-1 pb-4 text-center text-sm transition-all ${
                mode === "signup"
                  ? "font-bold border-b-2 border-[#0F4C5C] text-[#0F4C5C]"
                  : "font-medium text-slate-400 hover:text-slate-600 transition-all"
              }`}
            >
              Create Account
            </button>
            ...
            {mode === "login" ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <Mail
                        className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-[#0F4C5C] transition-colors"
                        size={20}
                      />
                      <input
                        type="email"
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <button
                        type="button"
                        className="text-[10px] font-black text-[#0F4C5C] uppercase tracking-wider hover:underline"
                      >
                        Forgot?
                      </button>
                    </div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="relative flex items-center">
                      <input
                        type="checkbox"
                        id="remember"
                        className="peer appearance-none w-5 h-5 rounded-lg border-2 border-slate-200 checked:bg-[#0F4C5C] checked:border-[#0F4C5C] transition-all cursor-pointer"
                      />
                      <CheckCircle2
                        size={14}
                        className="absolute left-0.5 pointer-events-none text-white opacity-0 peer-checked:opacity-100 transition-all"
                      />
                    </div>
                    <label
                      htmlFor="remember"
                  ...
                  <button className="w-full py-4 bg-[#0F4C5C] text-white rounded-2xl font-black flex items-center justify-center gap-3 hover:shadow-xl hover:shadow-[#0F4C5C]/20 transition-all active:scale-[0.98] group">
                    VÀO HỆ THỐNG{" "}
                    <ArrowRight
                      size={20}
              ...
              >
                <header>
                  ...
                  <p className="text-slate-500 mt-2">
                    Điền thông tin để bắt đầu trải nghiệm IRMS Pro.
                  </p>
                </header>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <div className="relative group">
                        <User
                          className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-[#0F4C5C] transition-colors"
                          size={18}
                        />
                        <input
                          type="text"
                          placeholder="Nguyễn Văn A"
                          className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:bg-white focus:ring-4 focus:ring-[#0F4C5C]/5 focus:border-[#0F4C5C] outline-none transition-all text-sm"
                          required
                        />
                      </div>
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-12 py-3 bg-slate-50 border border-slate-100 rounded-xl focus:bg-white focus:ring-4 focus:ring-[#0F4C5C]/5 focus:border-[#0F4C5C] outline-none transition-all text-sm"
                        required
                      />
                      <button
                        type="button"
                ...
                <p className="text-center text-[10px] text-slate-400 mt-6 leading-relaxed">
                  ...
                  <a href="#" className="text-[#0F4C5C] font-bold">
                    Điều khoản dịch vụ
                  </a>{" "}
                  và{" "}
                  <a href="#" className="text-[#0F4C5C] font-bold">
